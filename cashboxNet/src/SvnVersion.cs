...
namespace cashboxNet
{
  public class CashboxNetVersion
  {
    ...
    public const string VersionRevision = "407b012ad354c5732d05d5225ebb53bbde9105f2";
    public const string VersionModified = "Modified";
    public const string VersionDateTime = "2025-10-30 19-16-53";
